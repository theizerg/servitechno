<div class="modal fade" id="updateTipoE{{ $reparaciontipo->id }}" tabindex="-1" role="dialog" aria-labelledby="formModal"
          aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                {!! Form::model($reparaciontipo, ['route' => ['tipoequipos.update',$reparaciontipo->id],'method' => 'PUT']) !!}
