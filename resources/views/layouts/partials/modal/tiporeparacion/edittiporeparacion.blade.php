<div class="modal fade" id="updateTipoR{{ $reparaciontipo->id }}" tabindex="-1" role="dialog" aria-labelledby="formModal"
          aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                {!! Form::model($reparaciontipo, ['route' => ['tiporeparaciones.update',$reparaciontipo->id],'method' => 'PUT']) !!}
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" placeholder="Descripción de la reparación"
                       name="descripcion" value="{{ $reparaciontipo->descripcion }}">
                    </div>
                  </div>
