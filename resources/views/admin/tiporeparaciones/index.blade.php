...
@section('title', 'Tipo de reparaciones')
@section('content')
<div class="row">
  <div class="ml-3 col-md-6">
        <div class="btn-group">
        <button type="button" class="btn btn-primary blue darken-4 mb-4"
        data-toggle="modal" data-target="#createModalTipoReparacion">
            ...
            <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a  data-toggle="modal" data-target="#updateTipoR{{ $reparaciontipo->id }}" class="btn btn-round blue darken-4"><i class="mdi mdi-pencil mt-2 text-white" data-toggle="tooltip" data-placement="top"
                    title="Editar datos del organismo."></i></a>
                <a href="{{url('/tiporeparaciones/'.$reparaciontipo->id)}} " class="btn btn-round red darken-4"><i class="mdi mdi-delete mt-2 text-white" data-toggle="tooltip" data-placement="top"
                    title="Eliminar dato del organismo."></i></a>

                </td>
              </tr>
               @include('layouts.partials.modal..tiporeparacion.edittiporeparacion')
              @endforeach
            </tbody>
