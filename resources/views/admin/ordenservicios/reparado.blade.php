    ...
    <div class="col-12">
      <div class="card card-line-primary">
        <div class="card-header">
          <h4>Listado de equipos reparados</h4>
        </div>
        ...
        <div class="card-body">
          ...
          <div class="btn-group  ">
              ...
              <a href="{{ ('/ordenservicios/reparados') }}" class="btn btn-lg blue darken-4 text-white disabled">Equipos reparados</a>
              ...
              <a href="{{ ('/ordenservicios/reincidencias') }}" class="btn btn-lg blue darken-4 text-white">Reincidencias</a>
               <a href="{{ ('/ordenservicios/entregados') }}" class="btn btn-lg blue darken-4 text-white">Entregados</a>
            </div>
            ...
            <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <a href="{{ url('/ordenservicios/enviar') }}" class="btn btn-round yellow darken-4"><i class="mdi mdi-message mt-2 text-white" data-toggle="tooltip" data-placement="top"
                    title="Enviar alerta de reparación de equipo."></i></a>
                </td>
